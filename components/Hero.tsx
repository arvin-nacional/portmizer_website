  ...
  return (
    <div className="w-full h-screen flex justify-center items-center overflow-hidden ">
      ...
      >
        <CarouselContent>
          <CarouselItem>
            <div className="bg-[url('/assets/images/slider-2.jpg')] bg-cover bg-center w-full flex justify-center items-center  sm:px-12 min-h-[600px]">
          ...
          <CarouselItem>
            <div className="bg-[url('/assets/images/hero-image-3.jpg')] bg-cover bg-center w-full flex justify-center items-center sm:px-12">
              <Card className="w-[1200px] pb-6 max-md:mt-10 mt-10">
                <CardContent className="flex flex-col h-screen items-start justify-center gap-10">
                  <h1 className="text-5xl font-semibold text-light-900 max-sm:text-2xl">
          ...
          <CarouselItem>
            <div className="bg-[url('/assets/images/slider-3.jpg')] bg-cover bg-center w-full flex justify-center items-center sm:px-12">
              <Card className="w-[1200px] pb-6 max-md:mt-10 mt-10">
                <CardContent className="flex flex-col h-screen items-start justify-center gap-10">
                  <h1 className="text-5xl font-semibold text-light-900 max-sm:text-2xl">

...
const Clients = () => {
  ...
  //         prevIndex >= clientLogo.length - 1 ? 0 : prevIndex + 1
  //       );
  //     }, 3000);

  //     return () => clearInterval(interval);
  //   }, [currentIndex, clientLogo.length]);

  const handlePrev = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === 0 ? clientLogo.length - 1 : prevIndex - 1
    );
  };
  ...
  return (
    <section className="background-light400_dark300 flex items-center justify-center px-16 py-20 max-sm:py-10 max-md:px-5 sm:px-14">
          ...
          <div
            ...
            style={{
              transform: `translateX(-${
                (currentIndex / clientLogo.length) * 100
              }%)`,
              width: `${(clientLogo.length / itemsPerPage) * 100}%`,
            }}
          >

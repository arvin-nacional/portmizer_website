      ...
      <div className="w-[1200px] max-w-full pb-6 max-md:mt-10 gap-10  align-top px-2">
        <div>
          ...
          <p className="w-1/2 mt-5 max-sm:w-full">
            We offer genuine spare parts, preventive maintenance, performance
            upgrades, conversions, overhauling, and training to keep your port
            equipment running efficiently. Trust our experts for reliable
            support and solutions.
          </p>
          <div className="grid grid-cols-3 gap-10 max-sm:grid-cols-1 max-md:grid-cols-2 mt-5">
            {servicesCard.map((component) => (
              <ProductCard
